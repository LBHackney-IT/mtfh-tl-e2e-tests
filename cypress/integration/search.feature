...
Feature: T&L Search Function
  ...
  Scenario Outline: Initial person search
    Given the person has multiple tenures
    And I click on the radio button for "<searchType>"
    And I enter any of the following criteria "<characters>"
    When I view the person's results card
    Then I can see the text Multiple tenures instead of address
