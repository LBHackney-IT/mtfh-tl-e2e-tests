...
Feature: Add a new person to a tenure
  ...
  Scenario Outline: Person Contact details/Minimum fields
    ...
    Scenario Outline: Edit a tenure
      ...
      Examples:
        | tenure                               | title | personType          | firstName | middleName | lastName | day | month | year | gender | nationality | nationalInsuranceNumber | placeOfBirth | preferredTitle | preferredFirstName | preferredMiddleName | preferredLastName | language | idType          | idNumber | idSeen | email                  | emailDescription | phoneNumber | phoneType | phoneDescription | modifiedTitle | modifiedFirstName | modifiedMiddleName | modifiedLastName | modifiedDay | modifiedMonth | modifiedYear | modifiedPlaceOfBirth | modifiedPreferredTitle | modifiedPreferredFirstName | modifiedPreferredMiddleName | modifiedPreferredLastName |
        ...
        | e31bd4e3-8639-35ee-9849-47f5ae62ac17 | Mrs   | Household member    | Original  | Test       | guid     | 30  | 06    | 1988 | Male   | Greek       | AA123456C               | Crete        | Ms             | Pref orig          | Mid orig            | guid              | Sanskrit | Driving Licence | 111111   | No     | testymctester@test.com | This is an email | 99988199    | Mobile    | This is a phone  | Mr            | Modified          | modified           | guid             | 30          | 03            | 2015         | Sao Paulo            | Mrs                    | Modified first             | Modifield middle            | modified last             |

        # | tenure                               | title | personType          | firstName | middleName | lastName | day | month | year | gender | nationality | nationalInsuranceNumber | placeOfBirth | preferredTitle | preferredFirstName | preferredMiddleName | preferredLastName | language | idType          | idNumber | idSeen | email                  | emailDescription | phoneNumber | phoneType | phoneDescription | modifiedTitle | modifiedFirstName | modifiedMiddleName | modifiedLastName | modifiedDay | modifiedMonth | modifiedYear | modifiedPlaceOfBirth | modifiedPreferredTitle | modifiedPreferredFirstName | modifiedPreferredMiddleName | modifiedPreferredLastName | modifiedGender | modifiedNationality | modifiedNationalInsuranceNumber |
        # | e31bd4e3-8639-35ee-9849-47f5ae62ac17 | Mr    | Named tenure holder | Original  | Test       | guid     | 09  | 12    | 1950 | Female | Japanese    | AA123456C               | Mt. Fuji     | Reverend       | Pref orig          | Mid orig            | guid              | Occitan  | Passport        | 999999   | Yes    | testytest@test.com     | This is an email | 0118999     | Other     | This is a phone  | Ms            | Modified          | modified           | guid             | 12          | 12            | 2012         | Geneva               | Mr                     | Modified first             | Modifield middle            | modified last             | Male           | Greek               | BB123456C                       |
        # | e31bd4e3-8639-35ee-9849-47f5ae62ac17 | Mrs   | Household member    | Original  | Test       | guid     | 30  | 06    | 1988 | Male   | Greek       | AA123456C               | Crete        | Ms             | Pref orig          | Mid orig            | guid              | Sanskrit | Driving Licence | 111111   | No     | testymctester@test.com | This is an email | 99988199    | Mobile    | This is a phone  | Mr            | Modified          | modified           | guid             | 30          | 03            | 2015         | Sao Paulo            | Mrs                    | Modified first             | Modifield middle            | modified last             | Female         | Japanese            | BB123456C                       |
