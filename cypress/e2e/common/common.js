...
export const addTestRecordToDatabase = (dbTableName, testDbRecord) => {
  cy.log(`Adding test record to database table ${dbTableName} and creating a record of it in recordsToDelete.json file`).then(async () => {
    return new Cypress.Promise((resolve) => {
      ...
      cy.log("Test record added to the database successfully!");
    })
  })
}
