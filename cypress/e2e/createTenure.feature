...
#
  ...
  Scenario Outline: Create new tenure and add new person
    ...
    And the tenure person search is displayed
      ...
      Examples:
      | tenureType | startDay | startMonth | startYear | searchTerm | title   | personType          | firstName | middleName | lastName | day | month | year | placeOfBirth | preferredTitle | preferredFirstName | preferredMiddleName | preferredLastName | email                          | emailDescription              | phoneNumber | phoneType | phoneDescription              |
      | Freehold   | 01       | 01         | 2000      | tre        | Miss    | Named tenure holder | Test      | Test       | Test     | 08  | 05    | 1969 | Hospital     | Mrs            | Alan               | Coach Feratu        | Jefferson         | addPersonToNewTenure@email.com | Add person to new tenure test | 01189998    | Other     | Add person to new tenure test |
...
#
#    Examples:
#        | property                             | tenureType | startDay | startMonth | startYear | searchTerm | searchTerm2 |
#        | aff61bd4-841b-b4dc-af23-dfbdb8cc8434 | Freehold   | 01       | 01         | 2000      | tre        | dwa         |
#
#  @ignore
#  @SmokeTest
